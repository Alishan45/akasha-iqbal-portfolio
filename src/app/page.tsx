...
export default function Home() {
  ...
  return (
    <main>
        <nav className="site-nav" aria-label="Primary navigation"><a className="wordmark" href="#top">Akasha Iqbal<span>.</span></a><div className="nav-links"><a href="#about">About</a><a href="#work">Experience</a><a href="#research">Research</a><a href="#contact">Contact</a></div><a className="nav-download" href="/CV.pdf" download>Download CV <span>↗</span></a></nav>
